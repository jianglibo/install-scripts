...
#      	  v.customize ['createmedium', '--filename',  'f:/vms/desktop', '--size', 100000]
      ...
      centos.vm.box = "geerlingguy/centos7"
      centos.vm.network "private_network", ip: "192.168.33.111"
    end
...
#      	  v.customize ['createmedium', '--filename',  'f:/vms/desktop', '--size', 100000]
      ...
      centos.vm.box = "geerlingguy/centos7"
      centos.vm.network "private_network", ip: "192.168.33.112"
    end
    ...
    config.vm.define "ubuntu" do |ubuntu|
    	...
    	ubuntu.vm.network "private_network", ip: "192.168.33.121"
  	end
